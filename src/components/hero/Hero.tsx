export const Hero = () => {
  return (
    <div className="hero h-auto lg:h-[80vh] max-w-7xl w-full py-10 px-8 mx-auto flex flex-col-reverse items-center gap-10 overflow-hidden xl:flex-row xl:justify-between">
